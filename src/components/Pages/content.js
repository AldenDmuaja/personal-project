    ...
    <div className="hero-content display-table">
      <div className="table-cell">
        <div className="container">
          <h1 className="hero-title mb-4">I Am Alden D Muaja</h1>
              ...
              <div className="row">
                  ...
                  <div className="row">
                    ...
                    <div className="col-sm-6 col-md-7">
                      <div className="about-info">
                        <p><span className="title-s">Name: </span> <span>Alden Daril Muaja</span></p>
                ...
                <div className="col-md-6">
                  <div className="about-me pt-4 pt-md-0">
                    ...
                    <p className="lead">
                      Halo nama saya Alden Daril Muaja. Saya adalah anak pertama dari 3 bersaudara, yang lahir
                      pada tanggal 4 oktober 2002. Sekilas mengenai pendidikan saya. Pada Tahun 2014 saya menamatkan
                      pendidikan SD saya di Sekolah Advent Palu, dan kemudia melanjutkan pendidikan SMP saya di SMP
                      Advent Palu tahun 2017 yang kemudian melanjutkan SMA saya di SMA Advent Palu dan tamat pada Tahun 2020.
                    </p>
                    <p className="lead">
                      ...
                      Internet, Mobile App, Games, etc.
                    </p>
                    <p className="lead">
                      Kedepannya saya ingin lebih memperdalam dan berfokus dalam mempelajari WEB Dev. Alasannya karena saya ingin
                      menjadi seorang Web Developer dan bekerja di International Company. Dan yang paling saya inginkan adalah 
                      bekerja sebagai seorang Web Developer di Google Company
                    </p>
                  </div>
                </div>
              </div>
